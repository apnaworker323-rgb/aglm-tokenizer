...
Generated: 2026-08-16T15:30:57.665062+00:00

Input directory: `/run/media/akash/18FAA791FAA76A28/aglm_project/data`

Supported files: 15
Ignored files: 15
Supported on-disk bytes: 7,432,146,324

## Supported files

| Bytes | Format | Relative path |
|---:|:---:|---|
| 6,856,406 | `.txt` | `code_alpaca_20k.txt` |
| 1,609,094 | `.txt` | `english_grammar_books.txt` |
...
| 76,498,735 | `.txt` | `hf_code_english_combined.txt` |
| 1,663 | `.json` | `lmsys_split_meta.json` |
| 2,057,594,002 | `.txt` | `lmsys_train_95.txt` |
| 103,449,814 | `.txt` | `lmsys_val_5.txt` |
| 4,601,314 | `.txt` | `master_grammar_corpus.txt` |
| 3,020,044 | `.txt` | `multilingual_grammar_rules.txt` |
| 24,514,466 | `.txt` | `python_codes_25k.txt` |
| 45,127,893 | `.txt` | `tinystories_english.txt` |
...
| 4,185 | unsupported extension | `download_and_save_hf_training_data.py` |
| 5,740 | unsupported extension | `download_grammar_books_and_datasets.py` |
