# ⚡ AGLM Universal Multilingual Tokenizer (1.55M+ Vocab)

[![Python 3.9+](https://img.shields.io/badge/Python-3.9%2B-blue.svg)](https://www.python.org/downloads/)
[![Vocab Size](https://img.shields.io/badge/Vocab%20Size-1%2C551%2C017-brightgreen.svg)](https://github.com/apnaworker323-rgb/aglm-tokenizer)
...
> **The next-generation production multilingual tokenizer engine engineered for Indian languages, Romanized Indic / Dravidian dialects (Hinglish, Tenglish, Tanglish, Kanglish, Manglish), global scripts (Arabic, Chinese, Japanese, Korean, Cyrillic), and software code.**

---

## 🚀 Key Highlights

* **🔥 1.55M+ Full-Capacity Universe (`AGLM-Universal-Max`)**: Ingests multi-tokenizer canonical pools (Sarvam AI, Navarasa 2.0, L3Cube-Pune, AI4Bharat Aksharantar) with empirical language-balanced utility ranking.
...
* **🔒 100% Exact Lossless Roundtrip**: Byte-level fast trie guarantee (`decode(encode(text)) == text`) with zero token loss or unmapped characters.
...
| Category / Language | AGLM 1.55M (Ours) | OpenAI GPT-4o (`o200k_base`) | Google Gemma 2 | Meta Llama 3 | AGLM Token Savings |
|:---|:---:|:---:|:---:|:---:|:---:|
...
# 1. Load the 1.55M+ Max Production Tokenizer
tokenizer = AGLMUniversalTokenizer.load("./exported_tokenizers/aglm_universal_1m")
print(f"Loaded AGLM Tokenizer (Vocab Size: {tokenizer.vocab_size:,})")

# 2. Encode any sentence (Indic, Romanized, English, Code, etc.)
...
* **Live 3-Way Split Screen**: Side-by-side real-time token segmentation across **AGLM 1.55M**, **OpenAI GPT-4o**, and **Google Gemma 2**.
...
├── exported_tokenizers/
│   ├── aglm_universal_1m/     # 1.55M+ Max Production Tokenizer (.json.gz)
│   ├── aglm_universal_max/    # Full Unlimited Universe Tokenizer (.json.gz)
